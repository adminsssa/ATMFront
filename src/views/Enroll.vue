  ...
  <div id="enrollFrame">
    <el-form :model="registerForm" ref="registerForm" :rules="rules">
      ...
      <el-form-item prop="password">
        <el-input v-model="registerForm.password" style="width: 280px" placeholder="请输入密码"></el-input>
      </el-form-item>
      <el-row id="seventhE">
...
export default {
  ...
  data() {
    return {
      registerForm: {name: null, idCard: null, telephone: null, address: null, cardNo: null, password: null},
      rules: {
          ...
          if (this.registerForm.telephone !== null) {
            if (this.registerForm.address !== null) {
              if (this.registerForm.cardNo !== null) {
                if (this.registerForm.password !== null) {
